 ...
 * @author migue
 */
public class BorrarD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Borrar elementos en la base de Docentes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarD(dui).setVisible(true);
            }
        });
    }
