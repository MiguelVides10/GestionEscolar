 ...
 * @author migue
 */
public class BorrarE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Eliminar Datos de la base en Estudiantes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarE(nie).setVisible(true);
            }
        });
    }
